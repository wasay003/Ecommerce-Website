    ...
    <ul>
        ...
        <?php
          if (isset($_SESSION['Email'])) {
              echo  "<b style='color:#262626'> Welcome " . $_SESSION['Email'] . "</b>";
        ...
        if (isset($_SESSION['Email'])) {
            ...
            echo "<a href='Sign-in.php' style='color:#262626'>
                    Sign In
                  </a>";
        }
        ...
        <?php
          if (isset($_SESSION['Email'])) {
              $id = $_SESSION['id'];
              echo  " <li><a href='User_View_Order.php?id=$id' style='color:#262626'> View Orders </a></li>";
...
?>
    ...
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <a href="order_place.php?id=<?php echo $row['id']; ?>" class="btn btn-success" name="order_button">Order</a>
